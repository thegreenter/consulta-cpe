...
class ConsultaApi
{
     ...
     * @param  \OpenAPI\Client\Model\CpeFilter $cpe_filter cpe_filter (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CpeResponse
     */
     ...
     *
     * @param  string $ruc RUC de quién realiza la consulta (required)
     * @param  \OpenAPI\Client\Model\CpeFilter $cpe_filter (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CpeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function consultarCpeWithHttpInfo($ruc, $cpe_filter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CpeResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CpeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\CpeResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CpeResponse',
