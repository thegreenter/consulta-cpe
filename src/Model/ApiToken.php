 ...
 * ApiToken Class
 */
class ApiToken implements ModelInterface, ArrayAccess
{
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in El tiempo de expiración en segundos. Concluído el tiempo podrá generar un nuevo token
     *
     * @return $this
     */
